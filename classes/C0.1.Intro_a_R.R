...
#En R podremos encontrar objetos que contengan mÃ¡s de un dato como puede ser una tabla, una matriz o un vector.
...
plantas[, "weight"]  #y otra mÃ¡s...

plantas[15, 1]  #imprimo en pantalla el valor que toma el peso (primera columna) en la planta nÃºmero 15
...
#al tratamiento 2 y que pesan mÃ¡s de 5.5
