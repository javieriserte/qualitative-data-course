...
que mientras R por defecto hace el muestreo sin reemplazo, Julia lo hace con
reemplazo si no le indicamos lo contrario.
...
datos, la función ecdf de la biblioteca StatsBase de Julia, permite observar la
